...
function NvidiaLogo() {
  return (
    <svg
      ...
      aria-hidden
      className="h-[1em] w-[5.42em] shrink-0"
    >
      <path
      ...
      />
      <path
        d="M463.9 151.934v13.127h3.707v-13.127Zm-29.164-.018v13.145h3.74v-10.2l2.918.01a2.674 2.674 0 0 1 2.086.724c.586.625.826 1.632.826 3.476v5.995h3.624V157.8c0-5.183-3.3-5.882-6.536-5.882Zm35.134.018v13.127h6.013c3.2 0 4.249-.533 5.38-1.727a7.352 7.352 0 0 0 1.316-4.692 7.789 7.789 0 0 0-1.2-4.516c-1.373-1.833-3.352-2.191-6.306-2.191Zm3.677 2.858h1.594c2.312 0 3.808 1.039 3.808 3.733s-1.5 3.734-3.808 3.734h-1.594Zm-14.992-2.858-3.094 10.4-2.965-10.4h-4l4.234 13.127h5.343l4.267-13.127Zm25.749 13.127h3.708v-13.126h-3.709Zm10.831-13.122-5.177 13.117h3.656l.819-2.318h6.126l.775 2.318h3.969l-5.216-13.118Zm2.407 2.393 2.246 6.145h-4.562Z"
...
const BACKERS = [
  { name: "Microsoft for Startups", Logo: MicrosoftLogo, href: undefined, ariaLabel: undefined },
  { name: "AWS for Startups", Logo: AwsLogo, href: undefined, ariaLabel: undefined },
  {
    name: "Inception",
    Logo: NvidiaLogo,
    href: "https://www.nvidia.com/en-in/startups/",
    ariaLabel: "NVIDIA Inception",
  },
] as const;
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1480px] flex-wrap items-center justify-center gap-x-[clamp(0.75rem,2vw,1.25rem)] gap-y-2 text-center">
        ...
        {BACKERS.map(({ name, Logo, href, ariaLabel = name }, index) => {
          const content = (
            <>
              <Logo />
            ...
            <span key={name} className="flex items-center gap-x-[clamp(0.75rem,2vw,1.25rem)]">
              ...
              {href ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label={`Learn about ${ariaLabel}`}
