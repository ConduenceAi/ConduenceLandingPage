...
export function WeMoveAsOne() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full w-full max-w-[1480px] flex-col items-center justify-center py-[clamp(4rem,10vh,7rem)]">
        <div className="flex w-full flex-col gap-[clamp(1.75rem,4vh,2.75rem)]">
